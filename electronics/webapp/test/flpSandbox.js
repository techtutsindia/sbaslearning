		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comlearnelectronics-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlearnelectronics-display": {
								"semanticObject": "comlearnelectronics",
								"action": "display",
								"description": "SAPUI5 Application for Storage Goods",
								"title": "Electronic Items",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.learn.electronics",
									"url": sap.ui.require.toUrl("com/learn/electronics")
								}
							}
						}
					}
